...
<div style="margin-top: 150px; " class="poll">
    ...
    <div class="poll-content">
        <form method="post" action="${root}/board/makepoll.do">
            <div class="poll-question">
                <input type="text" name="idx" placeholder="  목차"/>
                <br><br>
                <input type="text" name="title" placeholder="  제목"/>
                <br><br>
                <textarea class="form-control" name="content" rows="6" cols="60" placeholder="내용"></textarea>
            </div>
