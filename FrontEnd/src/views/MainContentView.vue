        ...
        <div id="introCarousel" class="carousel slide carousel-fade">
          ...
          <div class="carousel-inner" role="listbox">
            <div
              ...
              style="background-image: url('@/assets/img/intro-carousel/1.jpg')"
            >
            ...
            <div
              class="carousel-item"
              style="background-image: url('@/assets/img/intro-carousel/2.jpg')"
            >
              <div class="carousel-container">
                <div class="carousel-content">
            ...
            <div
              class="carousel-item"
              style="background-image: url('@/assets/img/intro-carousel/3.jpg')"
            >
              <div class="carousel-container">
                <div class="carousel-content">
            ...
            <div
              class="carousel-item"
              style="background-image: url('@/assets/img/intro-carousel/4.jpg')"
            >
              <div class="carousel-container">
                <div class="carousel-content">
            ...
            <div
              class="carousel-item"
              style="background-image: url('@/assets/img/intro-carousel/5.jpg')"
            >
              <div class="carousel-container">
                <div class="carousel-content">
              ...
              <c:when test="${not empty boardList}">
                <c:forEach items="${boardList}" var="board">
                  <tr>
                    <th>
                      <!-- !!!!!!!!!!!!!!!!!!!!!!!!! -->
                      <!-- <a href="${root}/board/update_form.do?idx=${board.idx}">${board.idx}</a> -->
                      <a href="#">회원정보수정으로 이동</a>
                    </th>
                    <td>${board.title}</td>
        ...
        <div class="container">
          ...
          <div class="row about-cols">
            <div>
              <h5>거래 정보</h5>
              <div
                style="overflow: auto; width: 200px; height: 450px"
                id="aptInfoByDongCode"
              ></div>
            </div>
      ...
      <section class="about" id="7">
        <div class="container">
          ...
          <div class="row about-cols">
            ...
            <div>
              <img
                src="${root}@/assets/img/sitemap.jpg"
