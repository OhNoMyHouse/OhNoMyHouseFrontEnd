    ...
    introCarousel
        ...
        .each(function (index) {
            index === 0
                ...
                : introCarouselIndicators.append(
                    "<li data-target='#introCarousel' data-slide-to='" + index + "'></li>"
                );
        });
...
// Login ************************************************
function showLogin() {
    var child = window.open('./html/login.html', 'new-window', 'width=400, height=800, top=200, left=200');
}
...
function showSignUp() {
    var child = window.open(
        './html/signup.html',
        'new-window',
        'width=500, height=1000, top=200, left=200'
    );
}
